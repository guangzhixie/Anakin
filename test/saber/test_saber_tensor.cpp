...
void tensor_constructor() {
    ...
    std::cout << "targetD is __host_target? " << std::is_same<target_D, __host_target>::value;
    std::cout << "targetD is target_H? " << std::is_same<target_D, target_H>::value;
    std::cout << "flag_type? " << flag_type();
