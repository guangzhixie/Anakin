...
int bm_pooling_fwd(bm_api_pooling_forward pooling_param){
    ...
    for(n_start = 0; n_start < input_n; n_start += n_step) { 
        ...
        for(h_start = 0-top_pad_h; h_start < input_h+bottom_pad_h-kh+1; h_start += h_step) {
            ...
            // call the DMA and pooling atomic operation
            ...
            // get the local memory address offset
            ...
            atomic_pooling_gen_cmd(
                ...
                n_slice, input_c, h_slice, input_w, // input N/C/H/W
                new_output_h, output_w, // output H/W
                kh, kw,
                new_top_pad_h, new_bottom_pad_h, left_pad_w, right_pad_w, // padding
                stride_h, stride_w,
                0,0,0,0,    // ins0 parameters
                is_avg_pooling,
                1.0f / (kw * kh), // avg_pooling_const
                &id_node
            );
            ...
            tensor_stride_move_gen_cmd(
                ...
                output_w,
                input_c * output_h * output_w, // dst N/C/H stride
                output_h * output_w,
                output_w,
                GDMA_TYPE_f32,
                0,                             // transpose
